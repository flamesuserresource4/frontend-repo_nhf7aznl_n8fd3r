  ...
  const projects = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1494059980473-813e73ee784b?q=80&w=1200&auto=format&fit=crop'
    },
    {
      title: '茶室ランディング',
      desc: '和モダンの世界観を伝える LP デザイン',
      tags: ['Design', 'Next.js', 'SEO'],
      image: 'https://images.unsplash.com/photo-1644300502181-66211901f482?ixlib=rb-4.1.0&w=1200&auto=format&fit=crop&q=80'
    },
    {
      title: '筆文字ジェネレーター',
      desc: '毛筆の質感を再現するジェネレーティブアプリ',
      tags: ['Canvas', 'Noise', 'Shader'],
      image: 'https://images.unsplash.com/photo-1521185496955-15097b20c5fe?q=80&w=1200&auto=format&fit=crop'
    }
  ]

  return (
    <section id="work" className="py-20 sm:py-24 bg-gradient-to-b from-slate-950 to-slate-900">
